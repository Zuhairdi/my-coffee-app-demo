...
class CustomVerticalCardPager extends StatefulWidget {
  ...
  @override
  _CustomVerticalCardPagerState createState() =>
      _CustomVerticalCardPagerState();
}

class _CustomVerticalCardPagerState extends State<CustomVerticalCardPager> {
...
class CardControllerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < images!.length; i++) {
      var cardWidth =
          max(cardMaxWidth - 60 * (currentPosition! - i).abs(), 0.0);
  ...
  double getStartPosition(cardWidth) {
    double position = 0;
